...
{
  [ToolboxItem(true)]
    [ToolboxBitmap(typeof(WizardForm), "SpatialModel.UI.Wizard.WizardForm.bmp")]
    [Designer("Monkey.Processing.UI.WizardFormDesigner, Monkey.Processing.UI, Version=1.0.4.0, Culture=neutral, PublicKeyToken=fe06e967d3cf723d")]
  public class WizardForm : System.Windows.Forms.UserControl
  {
    ...
    private HelpPosition   m_eHelpPosition = HelpPosition.AlignLeft; // wizard Help Button state
    ...
    private LineFrame lineDownLimit;
    ...
    [DefaultValue( typeof( WizardForm.WizardsButtons ), "All" )]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    [Editor("Monkey.Processing.UI.FlagsEditor, Monkey.Processing.UI, Version=1.0.4.0, Culture=neutral, PublicKeyToken=fe06e967d3cf723d", 
       typeof( UITypeEditor ) )]
    ...
    [DefaultValue( typeof( WizardForm.HelpPosition ), "AlignLeft" )]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    public HelpPosition HelpAlign
    {
      get
      {
    ...
    protected void ChangeButtonsStates()
    {
      ...
      bool bHelp = ( ( m_eButtons & WizardsButtons.Help ) == WizardsButtons.Help );
      bool bCancel = ( ( m_eButtons & WizardsButtons.Cancel ) == WizardsButtons.Cancel );
      bool bNext = ( ( m_eButtons & WizardsButtons.Next ) == WizardsButtons.Next );
      bool bPrev = ( ( m_eButtons & WizardsButtons.Previous ) == WizardsButtons.Previous );
      ...
      if( bHelp )
      {
        if( m_eHelpPosition == HelpPosition.AlignLeft ) // help button on default position
        {
          btnHelp.Left = 8;
          btnHelp.Top = yPos;
