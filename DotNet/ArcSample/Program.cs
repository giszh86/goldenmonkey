...
namespace ArcSample
{
    ...
    class Program
    {
        ...
        public static void Sample1()
        {
            ...
            IContext context = InstanceManager.Instance.Context;
            String baseDir = (String)(context.GetVariable("BaseDirectory"));
            String filePath = Path.GetFullPath(baseDir + "../Config/Models/" + "arcsample.xml");
            String dataBase = Path.GetFullPath(baseDir.Substring(0, baseDir.LastIndexOf("\\")) + "../../../data");
            String[] args = new String[6];
            args[0] = Path.GetFullPath(dataBase + "\\shp\\Road_L.shp");
            args[1] = Path.GetFullPath(dataBase + "\\Default.gdb\\RoadLBuffer");
            args[2] = "5 Kilometers";
            args[3] = "NAME";
            args[4] = Path.GetFullPath(dataBase + "\\shp\\Lake_R.shp");
            args[5] = Path.GetFullPath(dataBase + "\\Default.gdb\\RoadLakeClip");
